<x-layout>
    <div class="container">
        ...
        <div class="row height-custom justify-content-center align-items-center text-center">
            <div class="col-12">
                <h1 class="display-4">{{__('categories.title')}}</h1>
            </div>
        </div>
        ...
        <div class="row height-custom justify-content-center py-5">
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                @else
                    <img src="{{'./img/img_cat/cat'.($article->category->id).'.jpeg'}}" alt="Nessuna foto inserita dall'utente">
                @endif
            </div>

        <!-- Dettagli dell'articolo -->
        <div class="col-12 col-md-6 mb-3 height-custom text-start">
            <h2 class="display-5"><span class="fw-bold">{{__('categories.object')}} </span>{{ $article->title }}</h2>
