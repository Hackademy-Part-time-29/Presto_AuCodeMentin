<x-layout>
  ...
  <div class="row">
    ...
    <div class="login row justify-content-center align-item-center">
            <div class="col-12">
                ...
                <form method="POST" action="/login" class="form">
                    ...
                    <span class="forgot-password"><a href="#">Hai dimenticato la password? Sei stupido come
                            Ale!</a></span>
                    <span class="forgot-password"><a href="{{ route('register') }}">Se non sei registrato, fallo
                            subito!</a></span>
